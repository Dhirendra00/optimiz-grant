...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const { userId, userEmail, userName }: VerificationEmailRequest = await req.json();

    console.log("Sending verification email to:", { userId, userEmail, userName });
            ...
            <div style="background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
              ...
              <div style="padding: 40px 30px;">
                <h2 style="color: #1a1a1a; margin: 0 0 20px; font-size: 24px; font-weight: 600;">
                  Hello ${userName || 'there'}, welcome to OptimizGrant!
                </h2>
                
                <p style="color: #4a4a4a; font-size: 16px; margin: 0 0 30px;">
                  Thank you for creating an account. Please verify your email address to access your dashboard and start your journey to funding success.
                </p>
              ...
              <div style="background: #f8f9fa; padding: 25px 30px; border-top: 1px solid #e5e7eb;">
                ...
                <div style="margin-top: 25px; padding-top: 20px; border-top: 1px solid #e5e7eb; text-align: center;">
                  <p style="color: #9ca3af; font-size: 12px; margin: 0;">
                    🔒 For security, this is an automated message. If you didn't create an account with OptimizGrant, please ignore this email.
                  </p>
                </div>
              </div>
            </div>
